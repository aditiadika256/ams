1. Gunakan warna statis tanpa gradasi atau glassmorphism (kecuali untuk kartu)
...
5. Layout & UX
Pertahankan layout dan UX saat ini pada versi desktop dan mobile karena usdah sesuai
...
7. 1 Component theme toggle untuk seluruh menu
Mekanisme adalah tanpa dropdown maka langsung mengganti theme

gunakan npm install @theme-toggles/react (sudah saya eksekusi)
...
lalu transisi gunakan skiper-UI
"use client";
...
Standard management page admin :
- button tambah kanan atas lalu menggunakan modal dan gunakan modal style seperti di "roles-permissions-view.tsx" untuk create/tambah
